...
const Producto = () => {
    ...
    const { creado, descripcion, empresa, nombre, url, votos, urlimagen, comentarios, creador, haVotado } = producto;
    ...
    const votarProducto = () => {
        ...
        guardarConsultarDB(true); // Cuando exista un voto se realiza la consulta a la base de datos
    }

    // Funciones para guardar los Comentarios
    ...
    const agregarComentario = e =>{
        ...
        guardarConsultarDB(true); // Cuando se guarde un nuevo comentario se consulta la base de datos tambien
    }

    // Funcion pára revisar que este autenticado el usuario
    const puedeBorrar = () =>{
    ...
    // Funcion para que elimine un Producto
                        ...
                        <ContenedorProducto>
                            <div>
                                ...
                                <h2
                                    ...
                                    `}
                                >Comentarios</h2>
                                { comentarios.length === 0 ? "Aún no hay comentarios, empieza agregando uno " : 
                                (
                                    <ul>
